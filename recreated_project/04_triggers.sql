...
AFTER INSERT ON db_project_example.USERS
FOR EACH ROW
BEGIN
    INSERT INTO db_project_example.TRANSACTIONS (
        ENTITY_NAME,
        OPERATION_TYPE,
        REFERENCE_ID,
        OPERATION_DATE
...
AFTER INSERT ON db_project_example.ENTRIES
FOR EACH ROW
BEGIN
    INSERT INTO db_project_example.TRANSACTIONS (
        ENTITY_NAME,
...
AFTER INSERT ON db_project_example.MESSAGES
FOR EACH ROW
BEGIN
    INSERT INTO db_project_example.TRANSACTIONS (
        ENTITY_NAME,
...
AFTER INSERT ON db_project_example.COMMENTS
FOR EACH ROW
BEGIN
    INSERT INTO db_project_example.TRANSACTIONS (
        ENTITY_NAME,
...
AFTER INSERT ON db_project_example.LIKES
FOR EACH ROW
BEGIN
    INSERT INTO db_project_example.TRANSACTIONS (
        ENTITY_NAME,
...
AFTER INSERT ON db_project_example.REPORTS
FOR EACH ROW
BEGIN
    INSERT INTO db_project_example.TRANSACTIONS (
        ENTITY_NAME,
...
AFTER INSERT ON db_project_example.SAVED_ENTRIES
FOR EACH ROW
BEGIN
    INSERT INTO db_project_example.TRANSACTIONS (
        ENTITY_NAME,
...
AFTER INSERT ON db_project_example.CHANNELS
FOR EACH ROW
BEGIN
    INSERT INTO db_project_example.TRANSACTIONS (
        ENTITY_NAME,
